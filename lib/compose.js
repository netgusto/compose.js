...
function _compose() {
    ...
    var res = Object.assign({}, basefactoryobject, {
        init: function init(buildprops) {
            var _this = this;

            factobjects.map(function (factory) {
                return 'init' in factory ? factory.init.apply(_this, [buildprops]) : null;
            });
        },
        ...
        create: function create() {
            ...
            var compiled = Object.assign({}, (0, _clone2.default)(this.props, false), this.methods);
